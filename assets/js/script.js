...
function wa(isi) 
{
	open("https://wa.me/6285817355659?text=Makasih ya udah inget hari ulang tahun aku,aku sayang banget sama kamu,emm aku pengin" + isi)
}
...
async function makeawish() 
{
	var {
		...
		title: 'Di hari spesial ini, kamu mau apa? Tapi ntar nunggu ada duit hhe',
		imageWidth: 400,
		imageHeight: 400,
